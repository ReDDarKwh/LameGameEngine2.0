...
var objects = {
  ...
  update : {
    ...
    "player":function(inst,dt){
      ...
      if(-((can.width/2)/gameScaleX)>world.x && ((can.width/2)/gameScaleX)<world.x+world.width ){
      ...
      if(-((can.height/2)/gameScaleY)>world.y && ((can.height/2)/gameScaleY)< world.y+world.height ){
